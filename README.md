...
<p>
Passionate about competitive programming and problem-solving on Codeforces.<br>
I enjoy building clean, efficient code and currently diving deep into object-oriented and functional programming with C++.
</p>
...
![Profile Views](https://komarev.com/ghpvc/?username=YazanBrijawi&style=flat&color=orange&label=PROFILE+VIEWS)
...
**Rock Paper Scissors**  
Classic C++ game where you play against the computer with score tracking and replay.  
Implemented using both procedural functions and object-oriented design to demonstrate different paradigms.

🔗 [Rock_paper_scissor](https://github.com/YazanBrijawi/Rock_paper_scissor) *(replace with your actual repo link)*
